...
export const aboutConfig = {
  hero: {
    title: "About United Awakening Pentecostal Church (U.A.P.C)",
    subtitle:
      "We are a church that believes in Jesus & loves God and people. We are a multi-cultural and multi-generational church committed to reaching the city of Kansas City and Beyond. We exist to help you and your family grow closer to your God-given purpose. Everyone has a first step to take in their journey. Will you take your first step this Sunday?",
  },
  story: {
    title: "Meet Our Pastors",
    content:
      "David and Neelu are the Founding Pastors of United Awakening Pentecostal Church. Both came from Hindu families in South India. Soon after their encounter with the Living God Jesus Christ, God called them into full-time ministry. Together, they have served in church and ministry for around 20 years, and 18 years ago God called David to be a missionary to the USA. After their marriage, both traveled to different parts of the USA ministering to ethnic churches like Russians/Ukrainians, Armenians, Ethiopians, South Sudanese, Koreans, Hmong, Messianic Jews, Nepali/Bhutanese, Indians, Hispanics, and Americans. The Lord planted within David and Neelu’s heart the vision to plant a Church in Kansas City to reach ALL PEOPLE GROUPS with the LOVE and HOPE of Lord Jesus Christ. Pastor David is a graduate of Victory Bible College & Victory Missions from Tulsa, OK.",
  ...
  contact: {
    churchName: "United Awakening Pentecostal Church (U.A.P.C)",
    address: "1061 Gradview Blvd., Kansas City, KS 66102 - US",
    email: "zahabutvshow@gmail.com",
    website: "www.unitedpchurch.org",
    phoneNumbers: ["+1 (717) 621 9584", "+1 (336) 392 6378"],
    verse: "Mark 16:15",
  },
};